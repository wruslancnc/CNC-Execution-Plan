#ifndef BUFFEREDUPDOWNCOUNTER_H
#define BUFFEREDUPDOWNCOUNTER_H

#include <QDialog>
#include "ui_bufferedupdowncounter.h"
#include "configuredialog.h"

class BufferedUpdownCounter : public QDialog
{
	Q_OBJECT
signals:
    void refreshUI(int);
...
private:
    Ui::BufferedUpdownCounterClass ui;
    BufferedUdCounterCtrl* bfdUdCounterCtrl;
