...
"""
INPFILE = "A23-Ribbon100L-FC20-data_ngcode.ngc"
...
"""
OUTFILE = "04-Out-A23-Ribbon100L-FC20-data_ngcode.txt"
...
## SPLIT EACH LINES_INP[] USING "blank space" SEPARATOR, THAT IS  
## TO GET TO "#u" VALUE IN NGC CODE LINE EXAMPLE, SHOWN NEXT.
G01 F   19.970408 X[   -4.185877] Y[   -4.459418] (#u= 0.030670112 eps= 0.000000625308 Xfrate= -13.153289 Yfrate= -15.026915 frlimit= 19.986539 frdiff=  0.016131408 frcmd= 20.000 #)  
NOTE: #u VALUE IS AT COLUMN NUM [9] 

G01 CODE LINE BEGINS FROM LINES_INP[14 -1] since line counting begins from 0
G01 CODE LINE ENDS AT LINES_INP[7613 -1] since line counting begins from 0
...
for currentline_num in range(START_LINENUM, END_LINENUM + 1, 1):
    ...
    if (readline_string[:3] == 'G01' and U_VAL != 1.0):
        ...
        ## print("line_as_list[8] = ", line_as_list[8]) 
...
"""
EXECUTION
wruslan@HPLaptop-01-ub20:~/github/wruslancnc/CNC-Execution-Plan/python-tools/histogram-from-NGC-Code$ python3 06-RUN-u-histogram-from-NGCode.py 
